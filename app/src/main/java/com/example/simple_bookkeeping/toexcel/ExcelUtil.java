        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    list.add(String.valueOf(demoBean.getTypename()));
                    list.add(String.valueOf(demoBean.getsImageId()));
                    list.add(String.valueOf(demoBean.getBeizhu()));
                    list.add(String.valueOf(demoBean.getMoney()));
                    list.add(String.valueOf(demoBean.getTime()));
                    list.add(String.valueOf(demoBean.getYear()));
                    list.add(String.valueOf(demoBean.getMonth()));
                    list.add(String.valueOf(demoBean.getDay()));
                    list.add(String.valueOf(demoBean.getKind()));
